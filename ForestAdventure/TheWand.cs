...
System.Console.WriteLine("You pick up " + WeaponChoice + " and notice that the wand looks very old and has writing in a language you don't understand.");
            Console.WriteLine("Without any spells you may as well have picked a sturdy stick. You pray you've made the right decision,");
            ...
            //if REACH IN Console.WriteLine("What great fortune! You have found a stone with writing in your native tounge and in the same writing as the wand. now you can translate the writing!");
            ...
            // if FIGHT Console.WriteLine("'Who are you calling a fool?' You right yourself and and tower over your opponent. You you point your wand into the goblins face. Gilgamere shreaks like a wee lass. 'Please! Please don't kill me! I was paid off! Its not me you want its him!!!");
            ...
            Console.WriteLine("You stand and stretch your sore muscles into places. You hear unsettling cackling behind you. You turn and see a woman across the clearing a broken broom laying mournfully in her mottled hand. She lays her eyes on you a haunting glowing green. A sinister smile rips across the decomposing flesh at her cheeks revealing a full set of sharp pointed teeth with death black gums making them seem as though the hung defying gravity in her mouth. you suddenly realize how that log found itself on the ground.");
            Console.WriteLine("Before you can make your next move the hag manages to cast a bolt of energy you manage to dodge and cast another in return but like a puppet on a string she shoots into the sky. some 50 ft by your best guess and begins raining down curses and some leaves tangle within her hair. In a howling voice it begins to speak. 'To think your people call you a King! HA! When it was soooo easy to take you off your steed with a single blow?! I figured why waste my time when even the carcass of this tattered old bird will do!'");
            ...
            /*if PLAY-DEAD             Console.WriteLine("Play dead. Nah man, you like dead, dead. That is a haunted, possessed, zombie Forest hag that is being controlled by an unseen person.... Did I mention Head Trauma? Cause I'm pretty sure I mentioned Head Trauma. Terrible choice bro. Like I wanna feel bad for you. But I don't.");
            Console.WriteLine("So like try again or whatever? But seriously who the heck just plays dead in front of a Zom-hag? What a freaking idiot LOL! XD ");
            Console.WriteLine("START over, or become the EMBARRASSMENT of the entire royal line?");

            string Zomhag = " START, EMBARRASSMENT";*/



            //if FIGHT 
            Console.WriteLine("You run like mad for the cover of the boulders and cliff to the far end of the clearing hoping to limit your vulnerability. The hag aims an exploding curse at the rock closest to you. As you turn away a shard of stone ricochets up the left side of your face marking you as a legend forever. Whether the blood or sweat stings your eyes worse you do not know. You can see only a shadow of the hag as she lands once more and begins to narrow in the distance between you both. You find yourself between literal rocks and an 5'8 hard place made of hair matted with old blood, razor sharp teeth, a gift for dark magic, and the smell of rot. As all of it springs from around the corner at you talons and teeth first you do the only thing you can think of. Draw your wand, take a deep breath recite the incantation, close your eyes and cry for mommy.");

            Console.WriteLine("Instead of the piercing and ripping of flesh, you feel the recoil as energy blasts forth from the end of your wand launching the reslain hag to the far other side of the clearing. A few leaves from her hair drift softly to the ground where she had been standing seconds before..");

            Console.WriteLine("While you try to fully understand all that has transpired the wind picks up ferociously. Whipping around the previous arena. The eerie green light that had previously been glowing from within the hags eyes now burst forth with a piercing scream. 'How could you have defeated me!!! The Head Mage for the Ashen Army!!! You haven't heard the last of me!' The light shoots to the sky lifting the hags body from the ground and disappearing it too in a whisper of smoke and ash. This too is violently swept up into the vortex. It hovers 100 feet in the air churning and green lightening streaking through the cloud and with a terrible explosion of thunder all is gone.");
            ...
            //tada game play THE WAND finished.
